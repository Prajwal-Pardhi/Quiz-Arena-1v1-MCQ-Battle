    ...
    <div className="home-wrapper">
      <NavigationBar/>
        <Container fluid className="home-container">
          <Row className="align-items-center min-vh-100 vw-100">
              <Col md={4} className="image-section">
                <img src="Quiz-Arena-Name.gif" alt="Quiz Arena" className="quiz-image" />
              </Col>
              ...
              <Col md={6} className="text-section">
                ...
                <p className="mb-4">Play with your friends.</p>
                <Button onClick={handleNavigateToLobby} variant="primary" size="lg" className="mr-3 mb-2 play-button">Lets Play</Button>
              </Col>
